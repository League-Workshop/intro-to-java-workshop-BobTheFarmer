...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		JOptionPane.showMessageDialog(null, "If you ever have to cross a piranha-infested river, heres how to do it...");
		...
		JOptionPane.showMessageDialog(null, "Piranhas are more " + adjective + " during the day, so cross the river at night. \n"
				+ "Piranhas are attracted to fresh " + liquid + " and will most likley take a bite out of your \n"
				+ Body_Part + " if you " + Verb + ". Whatever you do, if you have an open wound, try to find a way to get back to \n"
						+ "" + Place + "." );
